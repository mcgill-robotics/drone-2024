...
setup(
    ...
    description=
    'Mission manager package, translates globabl coordinates and high level orders and tells other nodes what to do.',
    license='Apache-2.0',
    tests_require=['pytest'],
    entry_points={
        'console_scripts': [
            'mission = mission_manager.mission:main',
            'mission_example = mission_manager.mission_json_runner:main'
        ],
    },
)
